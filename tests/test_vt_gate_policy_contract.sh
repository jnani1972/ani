...
grep -Fq 'Policy identifier: `ani-vt-candidate-selection-v1`' "$ROOT/SECURITY.md" || \
...
grep -q '^# ani-virustotal-results-v2$' "$RESULTS" || fail "results marker missing"
