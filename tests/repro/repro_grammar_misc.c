 ...
 * ANI_LANG_* now has a per-language RED/GREEN row on the bug-repro board.
 * ANI_LANG_OBJECTSCRIPT_EXPORT is intentionally excluded from the grammar
 ...
 * actually models (verified against internal/ani/lang_specs.c and the
 * *_func_types / *_class_types / *_call_types arrays):
 *
 *   CALLABLE family (func_types AND call_types both non-empty) -> FULL battery
 *   (dims 1-8) + robustness:
 *     VERILOG       -> ANI_LANG_VERILOG       (func: function_declaration/task;
 *                                              call: system_tf_call/subroutine_call)
 *     SYSTEMVERILOG -> ANI_LANG_SYSTEMVERILOG (func: function_declaration/task;
 *                                              call: function_subroutine_call)
 *     VHDL          -> ANI_LANG_VHDL          (func: subprogram_declaration/def;
 *                                              call: function_call/procedure_call)
 *     CFML          -> ANI_LANG_CFML          (func: function_declaration;
 *                                              call: call_expression)
 *     CFSCRIPT      -> ANI_LANG_CFSCRIPT      (func: function_declaration; call:
 *                                              js_call_types = call_expression)
 *     RESCRIPT      -> ANI_LANG_RESCRIPT      (func: function; call: call_expression)
 *     SQUIRREL      -> ANI_LANG_SQUIRREL      (func: function_declaration; call:
 *                                              call_expression)
 *     PINE          -> ANI_LANG_PINE          (func: function_declaration_statement;
 *                                              call: call)
 *     TEMPL         -> ANI_LANG_TEMPL         (func: function_declaration/method;
 *                                              call: call_expression)
 *     SQL           -> ANI_LANG_SQL           (func: create_function; call:
 *                                              function_call/invocation/command)
 *     OBJECTSCRIPT_UDL -> ANI_LANG_OBJECTSCRIPT_UDL
 *                                             (func: method/classmethod/query;
 *                                              call: four registered UDL forms)
 *     OBJECTSCRIPT_ROUTINE -> ANI_LANG_OBJECTSCRIPT_ROUTINE
 *                                             (func: tag; call: extrinsic_function/
 *                                              routine_tag_call)
 *     PLSQL         -> ANI_LANG_PLSQL         (func: create_function/procedure +
 ...
 *     ASSEMBLY      -> ANI_LANG_ASSEMBLY      (func_types = {"label"}; defs are
 *                                              labels routed through the func-def
 *                                              path -> "Function"). defs-present
 *                                              asserts "Function".
 *     LINKERSCRIPT  -> ANI_LANG_LINKERSCRIPT  (only module_types + call_types; no
 *                                              func/class/var defs in spec). NO
 *                                              defs-present assertion -- dims 1-4
 *                                              + robustness only.
 *     TABLEGEN      -> ANI_LANG_TABLEGEN      (func: def/multiclass/defm ->
 *                                              "Function"; class: class -> "Class").
 *                                              defs-present asserts "Function" and
 *                                              "Class". No call_types -> no call dim.
 *     BEANCOUNT     -> ANI_LANG_BEANCOUNT     (only module_types + import_types; no
 *                                              func/class/var/call defs in spec).
 *                                              NO defs-present -- dims 1-4 +
 *                                              robustness only.
 *     BICEP         -> ANI_LANG_BICEP         (func: user_defined_function ->
 ...
 *      deliberately truncated/broken version of the fixture. ani_extract_file may
 ...
 * tree-sitter enclosing-func walk (ani_find_enclosing_func + func_kinds_for_lang in
...
TEST(repro_grammar_misc_assembly) {
    ...
    if (misc_single_file_battery("ASSEMBLY", src, ANI_LANG_ASSEMBLY, "f.s",
                                 "Function", NULL, NULL) != 0)
        return 1;
    return misc_robustness("ASSEMBLY", bad, ANI_LANG_ASSEMBLY, "f.s");
}
...
TEST(repro_grammar_misc_beancount) {
    ...
    if (misc_single_file_battery("BEANCOUNT", src, ANI_LANG_BEANCOUNT,
                                 "main.beancount", NULL, NULL, NULL) != 0)
        return 1;
    return misc_robustness("BEANCOUNT", bad, ANI_LANG_BEANCOUNT,
                           "main.beancount");
}
...
TEST(repro_grammar_misc_bicep) {
    ...
    if (misc_single_file_battery("BICEP", src, ANI_LANG_BICEP, "main.bicep",
                                 "Class", NULL, NULL) != 0)
        return 1;
    return misc_robustness("BICEP", bad, ANI_LANG_BICEP, "main.bicep");
}
...
TEST(repro_grammar_misc_cfml) {
    ...
    if (misc_single_file_battery("CFML", src, ANI_LANG_CFML, "calc.cfm",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("CFML", bad, ANI_LANG_CFML, "calc.cfm") != 0)
        return 1;
...
TEST(repro_grammar_misc_cfscript) {
    ...
    if (misc_single_file_battery("CFSCRIPT", src, ANI_LANG_CFSCRIPT, "Calc.cfc",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("CFSCRIPT", bad, ANI_LANG_CFSCRIPT, "Calc.cfc") != 0)
        return 1;
...
TEST(repro_grammar_misc_linkerscript) {
    ...
    if (misc_single_file_battery("LINKERSCRIPT", src, ANI_LANG_LINKERSCRIPT,
                                 "link.ld", NULL, NULL, NULL) != 0)
        return 1;
    return misc_robustness("LINKERSCRIPT", bad, ANI_LANG_LINKERSCRIPT, "link.ld");
}
...
TEST(repro_grammar_misc_objectscript_udl) {
    ...
    if (misc_single_file_battery("OBJECTSCRIPT_UDL", src, ANI_LANG_OBJECTSCRIPT_UDL,
                                 "Callbacks.cls", "Method", NULL, "Accept") != 0)
        return 1;
    if (misc_robustness("OBJECTSCRIPT_UDL", bad, ANI_LANG_OBJECTSCRIPT_UDL, "Callbacks.cls") != 0)
        return 1;
...
TEST(repro_grammar_misc_objectscript_routine) {
    ...
    static const char bad[] = "SAMPLE\n"
                              ...
                              "Run(watched)\n"
                              "    Set result = $$Accept(\n";
    if (misc_single_file_battery("OBJECTSCRIPT_ROUTINE", src, ANI_LANG_OBJECTSCRIPT_ROUTINE,
                                 "Sample.mac", "Function", NULL, "Accept") != 0)
        return 1;
    if (misc_robustness("OBJECTSCRIPT_ROUTINE", bad, ANI_LANG_OBJECTSCRIPT_ROUTINE, "Sample.mac") !=
        0)
        return 1;
...
TEST(repro_grammar_misc_plsql) {
    ...
    static const char bad[] = "CREATE OR REPLACE PACKAGE BODY sample_pkg AS\n"
                              ...
                              "  BEGIN\n"
                              "    RETURN accept(\n";
    if (misc_single_file_battery("PLSQL", src, ANI_LANG_PLSQL, "sample_pkg.pkb", "Class",
                                 "Function", "accept") != 0)
        return 1;
    if (misc_robustness("PLSQL", bad, ANI_LANG_PLSQL, "sample_pkg.pkb") != 0)
        return 1;
...
TEST(repro_grammar_misc_pine) {
    static const char src[] =
        "//@version=5\n"
        "indicator(\"ANI EMA\", overlay=true)\n"
        "\n"
        "ema2(src, len) =>\n"
        "    a = src + len\n"
        "    a\n"
    ...
    if (misc_single_file_battery("PINE", src, ANI_LANG_PINE, "ind.pine",
                                 "Function", NULL, "ema2") != 0)
        return 1;
    if (misc_robustness("PINE", bad, ANI_LANG_PINE, "ind.pine") != 0)
        return 1;
...
TEST(repro_grammar_misc_rescript) {
    ...
    if (misc_single_file_battery("RESCRIPT", src, ANI_LANG_RESCRIPT, "Calc.res",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("RESCRIPT", bad, ANI_LANG_RESCRIPT, "Calc.res") != 0)
        return 1;
...
TEST(repro_grammar_misc_sql) {
    ...
    if (misc_single_file_battery("SQL", src, ANI_LANG_SQL, "fn.sql",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("SQL", bad, ANI_LANG_SQL, "fn.sql") != 0)
        return 1;
...
TEST(repro_grammar_misc_squirrel) {
    ...
    if (misc_single_file_battery("SQUIRREL", src, ANI_LANG_SQUIRREL, "calc.nut",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("SQUIRREL", bad, ANI_LANG_SQUIRREL, "calc.nut") != 0)
        return 1;
...
TEST(repro_grammar_misc_systemverilog) {
    ...
    if (misc_single_file_battery("SYSTEMVERILOG", src, ANI_LANG_SYSTEMVERILOG,
                                 "calc.sv", "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("SYSTEMVERILOG", bad, ANI_LANG_SYSTEMVERILOG,
                        "calc.sv") != 0)
        return 1;
...
TEST(repro_grammar_misc_tablegen) {
    ...
    if (misc_single_file_battery("TABLEGEN", src, ANI_LANG_TABLEGEN, "instr.td",
                                 "Function", "Class", NULL) != 0)
        return 1;
    return misc_robustness("TABLEGEN", bad, ANI_LANG_TABLEGEN, "instr.td");
}
...
TEST(repro_grammar_misc_templ) {
    ...
    if (misc_single_file_battery("TEMPL", src, ANI_LANG_TEMPL, "page.templ",
                                 "Function", NULL, "greeting") != 0)
        return 1;
    if (misc_robustness("TEMPL", bad, ANI_LANG_TEMPL, "page.templ") != 0)
        return 1;
...
TEST(repro_grammar_misc_verilog) {
    ...
    if (misc_single_file_battery("VERILOG", src, ANI_LANG_VERILOG, "calc.v",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("VERILOG", bad, ANI_LANG_VERILOG, "calc.v") != 0)
        return 1;
...
TEST(repro_grammar_misc_vhdl) {
    ...
    if (misc_single_file_battery("VHDL", src, ANI_LANG_VHDL, "calc.vhd",
                                 "Function", NULL, "add") != 0)
        return 1;
    if (misc_robustness("VHDL", bad, ANI_LANG_VHDL, "calc.vhd") != 0)
        return 1;
