 ...
 *   first one returned by ani_store_find_nodes_by_name) and BFS-traverses only
 ...
 *   Either in ani_store_find_nodes_by_name / ani_store_bfs (union traversal
...
TEST(repro_issue546_dts_split_caller_set) {
     ...
     *   ani_store_find_nodes_by_name).  Only callers whose CALLS edges
