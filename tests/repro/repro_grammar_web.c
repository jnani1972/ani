 ...
 * comment.
 *
 * Languages covered (12) and the ANI_LANG_* enum each uses (all verified in
 ...
 *   GoTemplate  -> ANI_LANG_GOTEMPLATE
 *   JSDoc       -> ANI_LANG_JSDOC
 *
 * BATTERY DIMENSIONS
 * ------------------
 ...
 *                          ani_find_enclosing_func relies on the same node being
...
TEST(repro_grammar_web_html) {
    static const char src[] =
        ...
        "</body>\n"
        "</html>\n";
    return structural_base_battery("HTML", src, ANI_LANG_HTML, "index.html");
}
...
TEST(repro_grammar_web_css) {
    static const char src[] =
        ...
        "  padding: 1rem;\n"
        "}\n";
    return callable_battery("CSS", src, ANI_LANG_CSS, "style.css",
                            NULL, "url");
}
...
TEST(repro_grammar_web_scss) {
    static const char src[] =
        ...
        "  background: #fff;\n"
        "}\n";
    if (callable_battery("SCSS", src, ANI_LANG_SCSS, "styles.scss",
...
TEST(repro_grammar_web_vue) {
    static const char src[] =
        ...
        "</style>\n";
    return structural_base_battery("Vue", src, ANI_LANG_VUE, "Hello.vue");
}
...
TEST(repro_grammar_web_svelte) {
    ...
    return structural_base_battery("Svelte", src, ANI_LANG_SVELTE,
                                   "Counter.svelte");
}
...
TEST(repro_grammar_web_astro) {
    static const char src[] =
        ...
        "  </body>\n"
        "</html>\n";
    return structural_base_battery("Astro", src, ANI_LANG_ASTRO,
                                   "index.astro");
}
...
TEST(repro_grammar_web_graphql) {
    static const char src[] =
        ...
        "  user(id: ID!): User\n"
        "}\n";
    return schema_battery("GraphQL", src, ANI_LANG_GRAPHQL, "schema.graphql",
                          "Class", "Field");
}
...
TEST(repro_grammar_web_protobuf) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Protobuf", src, ANI_LANG_PROTOBUF, "user.proto",
                          "Function", "Class");
}
...
TEST(repro_grammar_web_thrift) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Thrift", src, ANI_LANG_THRIFT, "user.thrift",
                          "Function", "Class");
}
...
TEST(repro_grammar_web_prisma) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Prisma", src, ANI_LANG_PRISMA, "schema.prisma",
                          "Class", "Field");
}
...
TEST(repro_grammar_web_gotemplate) {
    static const char src[] =
        ...
        "  {{ template \"greeting\" . }}\n"
        "{{ end }}\n";
    if (callable_battery("GoTemplate", src, ANI_LANG_GOTEMPLATE,
...
TEST(repro_grammar_web_jsdoc) {
    static const char src[] =
        ...
        " */\n";
    return structural_base_battery("JSDoc", src, ANI_LANG_JSDOC, "api.jsdoc");
}
