 ...
 *
 * Languages covered (18) and the ANI_LANG_* enum each uses. All enums verified
 * present in internal/ani/ani.h (line numbers as of HEAD): MARKDOWN(62),
 ...
 * None missing; none skipped. (Note: the enum is ANI_LANG_JINJA2, not
 * ANI_LANG_JINJA.)
 *
 *   MARKDOWN   -> ANI_LANG_MARKDOWN
 *   RST        -> ANI_LANG_RST
 *   TYPST      -> ANI_LANG_TYPST
 *   BIBTEX     -> ANI_LANG_BIBTEX
 *   MERMAID    -> ANI_LANG_MERMAID
 *   PO         -> ANI_LANG_PO
 *   DIFF       -> ANI_LANG_DIFF
 *   REGEX      -> ANI_LANG_REGEX
 ...
 *   BLADE      -> ANI_LANG_BLADE
 *   PURESCRIPT -> ANI_LANG_PURESCRIPT
 *   SOQL       -> ANI_LANG_SOQL
 *   SOSL       -> ANI_LANG_SOSL
 *
 * BATTERY DIMENSIONS
 ...
 *      through ani_extract_file must RETURN non-NULL (has_error may be set). A
...
TEST(repro_grammar_markup_markdown) {
     ...
     * the graph to "Class". */
    if (markup_struct_battery("Markdown", src, ANI_LANG_MARKDOWN, "README.md",
                              "Section", NULL) != 0)
        return 1;
    return markup_robustness("Markdown", bad, ANI_LANG_MARKDOWN, "README.md");
}
...
TEST(repro_grammar_markup_rst) {
    ...
    if (markup_base_battery("RST", src, ANI_LANG_RST, "index.rst") != 0)
        return 1;
    return markup_robustness("RST", bad, ANI_LANG_RST, "index.rst");
}
...
TEST(repro_grammar_markup_typst) {
    static const char src[] = "#let title = \"Ani\"\n"
    ...
    if (markup_callable_battery("Typst", src, ANI_LANG_TYPST, "doc.typ",
                                "Function", "greet") != 0)
        return 1;
    if (markup_robustness("Typst", bad, ANI_LANG_TYPST, "doc.typ") != 0)
        return 1;
...
TEST(repro_grammar_markup_bibtex) {
    ...
    if (markup_base_battery("BibTeX", src, ANI_LANG_BIBTEX, "refs.bib") != 0)
        return 1;
    return markup_robustness("BibTeX", bad, ANI_LANG_BIBTEX, "refs.bib");
}
...
TEST(repro_grammar_markup_mermaid) {
    ...
    if (markup_base_battery("Mermaid", src, ANI_LANG_MERMAID, "diagram.mmd") != 0)
        return 1;
    return markup_robustness("Mermaid", bad, ANI_LANG_MERMAID, "diagram.mmd");
}
...
TEST(repro_grammar_markup_po) {
    ...
    if (markup_base_battery("PO", src, ANI_LANG_PO, "de.po") != 0)
        return 1;
    return markup_robustness("PO", bad, ANI_LANG_PO, "de.po");
}
...
TEST(repro_grammar_markup_diff) {
    ...
    if (markup_base_battery("Diff", src, ANI_LANG_DIFF, "change.diff") != 0)
        return 1;
    return markup_robustness("Diff", bad, ANI_LANG_DIFF, "change.diff");
}
...
TEST(repro_grammar_markup_regex) {
    ...
    if (markup_base_battery("Regex", src, ANI_LANG_REGEX, "date.re") != 0)
        return 1;
    return markup_robustness("Regex", bad, ANI_LANG_REGEX, "date.re");
}
...
TEST(repro_grammar_markup_capnp) {
    ...
    if (markup_struct_battery("CapnP", src, ANI_LANG_CAPNP, "user.capnp",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("CapnP", bad, ANI_LANG_CAPNP, "user.capnp");
}
...
TEST(repro_grammar_markup_smithy) {
    ...
    if (markup_struct_battery("Smithy", src, ANI_LANG_SMITHY, "model.smithy",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("Smithy", bad, ANI_LANG_SMITHY, "model.smithy");
}
...
TEST(repro_grammar_markup_wit) {
    ...
    if (markup_struct_battery("WIT", src, ANI_LANG_WIT, "users.wit",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("WIT", bad, ANI_LANG_WIT, "users.wit");
}
...
TEST(repro_grammar_markup_qml) {
    ...
    if (markup_callable_battery("QML", src, ANI_LANG_QML, "Widget.qml",
                                "Function", "max") != 0)
        return 1;
    if (markup_robustness("QML", bad, ANI_LANG_QML, "Widget.qml") != 0)
        return 1;
...
TEST(repro_grammar_markup_liquid) {
    ...
    if (markup_base_battery("Liquid", src, ANI_LANG_LIQUID, "page.liquid") != 0)
        return 1;
    return markup_robustness("Liquid", bad, ANI_LANG_LIQUID, "page.liquid");
}
 ...
 * (Enum is ANI_LANG_JINJA2, verified at ani.h:114.)
 */
TEST(repro_grammar_markup_jinja2) {
    ...
    if (markup_base_battery("Jinja2", src, ANI_LANG_JINJA2, "page.j2") != 0)
        return 1;
    return markup_robustness("Jinja2", bad, ANI_LANG_JINJA2, "page.j2");
}
...
TEST(repro_grammar_markup_blade) {
    ...
    if (markup_base_battery("Blade", src, ANI_LANG_BLADE, "page.blade.php") != 0)
        return 1;
    return markup_robustness("Blade", bad, ANI_LANG_BLADE, "page.blade.php");
}
...
TEST(repro_grammar_markup_purescript) {
    ...
    if (markup_callable_battery("PureScript", src, ANI_LANG_PURESCRIPT, "Main.purs",
                                "Function", "greet") != 0)
        return 1;
    if (markup_robustness("PureScript", bad, ANI_LANG_PURESCRIPT, "Main.purs") != 0)
        return 1;
...
TEST(repro_grammar_markup_soql) {
    ...
    if (markup_base_battery("SOQL", src, ANI_LANG_SOQL, "query.soql") != 0)
        return 1;
    return markup_robustness("SOQL", bad, ANI_LANG_SOQL, "query.soql");
}
...
TEST(repro_grammar_markup_sosl) {
    ...
    if (markup_base_battery("SOSL", src, ANI_LANG_SOSL, "search.sosl") != 0)
        return 1;
    return markup_robustness("SOSL", bad, ANI_LANG_SOSL, "search.sosl");
}
