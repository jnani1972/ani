 ...
 * hybrid LSP (internal/ani/lsp/c_lsp.c).
 *
 ...
 *   these can silently fail: ani_pipeline_find_lsp_resolution
 ...
 *   the source (grep '"lsp_' internal/ani/lsp/c_lsp.c), with its keying site:
