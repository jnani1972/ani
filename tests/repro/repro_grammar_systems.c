 ...
 *
 * Languages covered (12) and the ANI_LANG_* enum each uses (every enum verified
 * present in internal/ani/ani.h; none missing, none skipped):
 *   Zig      -> ANI_LANG_ZIG
 *   Nim      -> ANI_LANG_NIM (explicitly unsupported; no grammar is vendored)
 *   Crystal  -> ANI_LANG_CRYSTAL
 *   Hare     -> ANI_LANG_HARE
 *   Odin     -> ANI_LANG_ODIN
 *   Pony     -> ANI_LANG_PONY
 *   Ada      -> ANI_LANG_ADA
 ...
 *   Pascal   -> ANI_LANG_PASCAL
 *   Solidity -> ANI_LANG_SOLIDITY
 *   Move     -> ANI_LANG_MOVE
 *
 * BATTERY DIMENSIONS
 * ------------------
 ...
 * compiled/OOP family: ani_find_enclosing_func (helpers.c) walks the TSNode
 ...
 * "function_declaration", so ani_find_enclosing_func resolves the caller and the
...
TEST(repro_grammar_systems_zig) {
    static const char src[] =
        ...
        "    return add(x, 1);\n"
        "}\n";
    if (single_file_battery("Zig", src, ANI_LANG_ZIG, "calc.zig",
...
TEST(repro_grammar_systems_nim) {
    ASSERT_NULL(ani_lang_spec(ANI_LANG_NIM));
    ASSERT_NULL(ani_ts_language(ANI_LANG_NIM));
    PASS();
}
 ...
 * func_kinds_generic, so ani_find_enclosing_func cannot reach the method and
...
TEST(repro_grammar_systems_crystal) {
    static const char src[] =
        ...
        "  end\n"
        "end\n";
    if (single_file_battery("Crystal", src, ANI_LANG_CRYSTAL, "calc.cr",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_hare) {
    static const char src[] =
        ...
        "\treturn add(x, 1);\n"
        "};\n";
    if (single_file_battery("Hare", src, ANI_LANG_HARE, "calc.ha",
                            "Function", NULL, "add") != 0)
        return 1;
 ...
 * not in func_kinds_generic, so ani_find_enclosing_func falls back to Module.
 */
TEST(repro_grammar_systems_odin) {
    static const char src[] =
        ...
        "\treturn add(x, 1)\n"
        "}\n";
    if (single_file_battery("Odin", src, ANI_LANG_ODIN, "calc.odin",
                            "Function", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_pony) {
    static const char src[] =
        ...
        "    add(x, 1)\n";
    if (single_file_battery("Pony", src, ANI_LANG_PONY, "calc.pony",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_ada) {
    static const char src[] =
        ...
        "\n"
        "end Calc;\n";
    if (single_file_battery("Ada", src, ANI_LANG_ADA, "calc.adb",
                            "Function", NULL, "Add") != 0)
        return 1;
...
TEST(repro_grammar_systems_fortran) {
    static const char src[] =
        ...
        "end module calc\n";
    if (single_file_battery("Fortran", src, ANI_LANG_FORTRAN, "calc.f90",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_cobol) {
    static const char src[] =
        ...
        "           EXIT PROGRAM.\n"
        "       END PROGRAM SUB.\n";
    if (single_file_battery("COBOL", src, ANI_LANG_COBOL, "calc.cob",
                            "Function", NULL, "SUB") != 0)
        return 1;
...
TEST(repro_grammar_systems_pascal) {
    static const char src[] =
        ...
        "begin\n"
        "end.\n";
    if (single_file_battery("Pascal", src, ANI_LANG_PASCAL, "calc.pas",
                            "Function", NULL, "Add") != 0)
        return 1;
 ...
 * so ani_find_enclosing_func resolves the enclosing function and attributes the
...
TEST(repro_grammar_systems_solidity) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Solidity", src, ANI_LANG_SOLIDITY, "Calc.sol",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_move) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Move", src, ANI_LANG_MOVE, "calc.move",
                            "Function", NULL, "add") != 0)
        return 1;
