 ...
 *   https://github.com/jnani1972/ani/issues/571
 *
 * ROOT CAUSE (src/pipeline/fqn.c, ani_project_name_from_path, lines ~341-348):
 *
...
TEST(repro_issue571_cjk_project_name) {
    ...
    char *name = ani_project_name_from_path(cjk_path);
