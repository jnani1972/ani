...
TEST(repro_grammar_build_gomod) {
    static const char src[] =
        "module github.com/DeusData/ani\n"
        "\n"
        "go 1.22\n"
        "\n"
        "require (\n"
        ...
        ")\n";
    static const char bad[] = "module github.com/DeusData/ani\nrequire (";
...
TEST(repro_grammar_build_requirements) {
    static const char src[] =
        ...
        "\n"
        "# URL requirement\n"
        "ani-client @ git+https://github.com/DeusData/ani-client.git@v0.8.1\n";
...
TEST(repro_grammar_build_bitbake) {
    ...
    static const char src[] =
        ...
        "PV          = \"0.8.1\"\n"
        "\n"
        "SRC_URI = \"git://github.com/DeusData/ani.git;protocol=https\"\n"
        "\n"
        "do_fetch() {\n"
        "    git clone ${SRC_URI} ${S}\n"
        "}\n"
