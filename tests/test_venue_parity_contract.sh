...
FORBIDDEN = [
    ...
    (re.compile(r"SMOKE_DOWNLOAD_URL|SMOKE_UPDATE_FIXTURE_DIR"),
     "fixture-server env is wrapper-owned; pass ANI_SMOKE_ARTIFACT_DIR instead"),
...
ALLOWED_EXTRA = {
    ...
    "release.yml": {"npm", "pip", "pip3", "twine", "python", "make",
                    "./mcp-publisher"},
    "_smoke.yml": {"ani"},  # brew-installed CLI version check
}
...
LOCAL_REQUIRED = [
    ...
    # (C:\ani\scripts\ci\ensure-defender.ps1).
