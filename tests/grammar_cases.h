 ...
 *   - test_grammar_regression.c : EXTRACTION-level breadth (ani_extract_file with
 ...
 */
#ifndef ANI_TEST_GRAMMAR_CASES_H
#define ANI_TEST_GRAMMAR_CASES_H
...
typedef struct {
    ...
    ANILanguage lang;       /* explicit language for extraction-level tests */
...
extern const GrammarCase ANI_GRAMMAR_CASES[];
extern const size_t ANI_GRAMMAR_CASES_COUNT;

#endif /* ANI_TEST_GRAMMAR_CASES_H */
