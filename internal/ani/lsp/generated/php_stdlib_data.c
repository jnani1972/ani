...
#define REG_METHOD(class_qn_, method_name_, ret_type_) do {                        \
    ...
    rf.min_params = -1;                                                            \
    rf.qualified_name = ani_arena_sprintf(arena, "%s.%s", (class_qn_), (method_name_)); \
    rf.short_name = (method_name_);                                                \
    rf.receiver_type = (class_qn_);                                                \
    {                                                                              \
        const ANIType **rets = (const ANIType **)ani_arena_alloc(arena, 2 * sizeof(*rets)); \
...
#define MIXED ani_type_unknown()

void ani_php_stdlib_register(ANITypeRegistry *reg, ANIArena *arena) {
    ...
    REG_METHOD("Throwable", "getMessage", ani_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getCode", ani_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getFile", ani_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getLine", ani_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getTrace", ani_type_builtin(arena, "array"));
    REG_METHOD("Throwable", "getTraceAsString", ani_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getPrevious", ani_type_named(arena, "Throwable"));
    ...
    REG_METHOD("DateTimeInterface", "format", ani_type_builtin(arena, "string"));
    REG_METHOD("DateTimeInterface", "getTimestamp", ani_type_builtin(arena, "int"));
    REG_METHOD("DateTimeInterface", "getOffset", ani_type_builtin(arena, "int"));
    REG_METHOD("DateTime", "modify", ani_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "add", ani_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "sub", ani_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setDate", ani_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setTime", ani_type_named(arena, "DateTime"));
    REG_METHOD("DateTimeImmutable", "modify", ani_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "add", ani_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "sub", ani_type_named(arena, "DateTimeImmutable"));
    ...
    REG_METHOD("Iterator", "next", ani_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "rewind", ani_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "valid", ani_type_builtin(arena, "bool"));
    REG_METHOD("Countable", "count", ani_type_builtin(arena, "int"));
    REG_METHOD("ArrayAccess", "offsetExists", ani_type_builtin(arena, "bool"));
    REG_METHOD("ArrayAccess", "offsetGet", MIXED);
    REG_METHOD("ArrayAccess", "offsetSet", ani_type_builtin(arena, "void"));
    REG_METHOD("ArrayAccess", "offsetUnset", ani_type_builtin(arena, "void"));
    REG_METHOD("Stringable", "__toString", ani_type_builtin(arena, "string"));
    REG_METHOD("ArrayObject", "getIterator", ani_type_named(arena, "ArrayIterator"));
    ...
    REG_METHOD("Psr.Log.LoggerInterface", "info", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "warning", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "error", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "debug", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "critical", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "log", ani_type_builtin(arena, "void"));
    REG_METHOD("Psr.Container.ContainerInterface", "get", MIXED);
    REG_METHOD("Psr.Container.ContainerInterface", "has", ani_type_builtin(arena, "bool"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getMethod", ani_type_builtin(arena, "string"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getUri",
               ani_type_named(arena, "Psr.Http.Message.UriInterface"));
    ...
    REG_METHOD("Closure", "bindTo", ani_type_named(arena, "Closure"));
    ...
    /* Eloquent Builder chain methods. */
    {
        ...
        const ANIType *self = ani_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const ANIType *coll = ani_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        const ANIType *model = ani_type_named(arena, "Illuminate.Database.Eloquent.Model");
        ...
        REG_METHOD(eb, "exists", ani_type_builtin(arena, "bool"));
        REG_METHOD(eb, "count", ani_type_builtin(arena, "int"));
        REG_METHOD(eb, "sum", ani_type_builtin(arena, "int"));
        REG_METHOD(eb, "value", MIXED);
        REG_METHOD(eb, "toSql", ani_type_builtin(arena, "string"));
    }

    /* Eloquent Model: convenience static-call entry points. */
    {
        const char *em = "Illuminate.Database.Eloquent.Model";
        const ANIType *eb = ani_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const ANIType *self = ani_type_named(arena, "Illuminate.Database.Eloquent.Model");
        const ANIType *coll = ani_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        ...
        REG_METHOD(em, "save", ani_type_builtin(arena, "bool"));
        REG_METHOD(em, "update", ani_type_builtin(arena, "bool"));
        REG_METHOD(em, "delete", ani_type_builtin(arena, "bool"));
        REG_METHOD(em, "fresh", self);
        REG_METHOD(em, "refresh", self);
        REG_METHOD(em, "load", self);
        REG_METHOD(em, "loadMissing", self);
        REG_METHOD(em, "toArray", ani_type_builtin(arena, "array"));
        REG_METHOD(em, "toJson", ani_type_builtin(arena, "string"));
    ...
    /* Illuminate\Support\Collection — chain returns self. */
    {
        ...
        const ANIType *self = ani_type_named(arena, "Illuminate.Support.Collection");
        ...
        REG_METHOD(coll_qn, "count", ani_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "isEmpty", ani_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "isNotEmpty", ani_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "contains", ani_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "toArray", ani_type_builtin(arena, "array"));
        REG_METHOD(coll_qn, "toJson", ani_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "implode", ani_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "sum", ani_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "avg", ani_type_builtin(arena, "float"));
    ...
    REG_TYPE("Carbon.CarbonImmutable", "CarbonImmutable", false, carbon_parents);
    {
        ...
        const ANIType *self = ani_type_named(arena, "Carbon.Carbon");
        ...
        REG_METHOD(c, "format", ani_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateString", ani_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateTimeString", ani_type_builtin(arena, "string"));
        REG_METHOD(c, "diffInDays", ani_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInHours", ani_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInMinutes", ani_type_builtin(arena, "int"));
    ...
    REG_METHOD("Psr.Http.Message.RequestInterface", "withMethod",
               ani_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "withUri",
               ani_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.ResponseInterface", "withStatus",
               ani_type_named(arena, "Psr.Http.Message.ResponseInterface"));
    ...
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "persist", ani_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "remove", ani_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "flush", ani_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQuery",
               ani_type_named(arena, "Doctrine.ORM.Query"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQueryBuilder",
               ani_type_named(arena, "Doctrine.ORM.QueryBuilder"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "getRepository",
               ani_type_named(arena, "Doctrine.ORM.EntityRepository"));
    {
        const char *qb = "Doctrine.ORM.QueryBuilder";
        const ANIType *self = ani_type_named(arena, "Doctrine.ORM.QueryBuilder");
        ...
        REG_METHOD(qb, "getQuery", ani_type_named(arena, "Doctrine.ORM.Query"));
    }
    REG_METHOD("Doctrine.ORM.Query", "getResult", ani_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.Query", "getOneOrNullResult", MIXED);
    REG_METHOD("Doctrine.ORM.Query", "execute", ani_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "find", MIXED);
    REG_METHOD("Doctrine.ORM.EntityRepository", "findAll", ani_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "findBy", ani_type_builtin(arena, "array"));
    ...
    REG_METHOD("Twig.Environment", "render", ani_type_builtin(arena, "string"));
    REG_METHOD("Twig.Environment", "load",
               ani_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.Environment", "createTemplate",
               ani_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.TemplateWrapper", "render", ani_type_builtin(arena, "string"));
    REG_METHOD("Twig.TemplateWrapper", "renderBlock", ani_type_builtin(arena, "string"));
    ...
    REG_METHOD("Symfony.Contracts.Cache.CacheInterface", "delete", ani_type_builtin(arena, "bool"));
    REG_METHOD("Symfony.Contracts.Cache.ItemInterface", "set",
               ani_type_named(arena, "Symfony.Contracts.Cache.ItemInterface"));
    ...
    REG_METHOD("Psr.Cache.CacheItemPoolInterface", "getItem",
               ani_type_named(arena, "Psr.Cache.CacheItemInterface"));
               ...
               ani_type_builtin(arena, "void"));
    {
        ...
        const ANIType *self = ani_type_named(arena, "Symfony.Component.Mime.Email");
    ...
    REG_METHOD("Illuminate.Http.Request", "all", ani_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Request", "user", MIXED);
    REG_METHOD("Illuminate.Http.Request", "validate", ani_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Response", "header",
               ani_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.Response", "withHeaders",
               ani_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.JsonResponse", "header",
               ani_type_named(arena, "Illuminate.Http.JsonResponse"));
    ...
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "user",
               ani_type_named(arena, "Illuminate.Contracts.Auth.Authenticatable"));
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "check", ani_type_builtin(arena, "bool"));
    ...
    REG_METHOD("Illuminate.Contracts.Session.Session", "put", ani_type_builtin(arena, "void"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "has", ani_type_builtin(arena, "bool"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "flash", ani_type_builtin(arena, "void"));

    REG_TYPE("Illuminate.View.View", "View", false, session_parents);
    REG_METHOD("Illuminate.View.View", "render", ani_type_builtin(arena, "string"));
    REG_METHOD("Illuminate.View.View", "with",
               ani_type_named(arena, "Illuminate.View.View"));
    ...
    REG_METHOD("React.Promise.PromiseInterface", "then",
               ani_type_named(arena, "React.Promise.PromiseInterface"));
    ...
    REG_METHOD("GuzzleHttp.Promise.PromiseInterface", "then",
               ani_type_named(arena, "GuzzleHttp.Promise.PromiseInterface"));
    ...
    REG_METHOD("Monolog.Logger", "pushHandler",
               ani_type_named(arena, "Monolog.Logger"));
    ...
    REG_METHOD("ReflectionClass", "getName", ani_type_builtin(arena, "string"));
    REG_METHOD("ReflectionClass", "getMethods", ani_type_builtin(arena, "array"));
    REG_METHOD("ReflectionClass", "getMethod",
               ani_type_named(arena, "ReflectionMethod"));
    ...
    REG_METHOD("ReflectionMethod", "getName", ani_type_builtin(arena, "string"));
    REG_METHOD("ReflectionProperty", "getValue", MIXED);
    REG_METHOD("ReflectionProperty", "setValue", ani_type_builtin(arena, "void"));
}
