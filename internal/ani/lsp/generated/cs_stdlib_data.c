...
#define REG_EXTENSION(qn_, short_name_, recv_, ret_type_)            \
    do {                                                             \
        ...
        {                                                            \
            ...
            rets[1] = NULL;                                          \
            const char **pnames =                                    \
                (const char **)ani_arena_alloc(arena, 2 * sizeof(*pnames)); \
            pnames[0] = "this";                                       \
            pnames[1] = NULL;                                        \
            const ANIType **ptypes =                                 \
                (const ANIType **)ani_arena_alloc(arena, 2 * sizeof(*ptypes)); \
            ptypes[0] = (recv_);                                     \
            ptypes[1] = NULL;                                        \
            rf.signature = ani_type_func(arena, pnames, ptypes, rets); \
        }                                                            \
        ani_registry_add_func(reg, rf);                              \
    } while (0)

#define OBJ() ani_type_named(arena, "System.Object")
#define STR() ani_type_named(arena, "System.String")
#define INT() ani_type_named(arena, "System.Int32")
#define LONG_T() ani_type_named(arena, "System.Int64")
#define BOOL_T() ani_type_named(arena, "System.Boolean")
#define DBL() ani_type_named(arena, "System.Double")
#define VOID_T() ani_type_named(arena, "System.Void")
#define UNK() ani_type_unknown()
...
void ani_csharp_stdlib_register(ANITypeRegistry *reg, ANIArena *arena) {
    ...
    REG_METHOD("System.Object", "GetType", ani_type_named(arena, "System.Type"));
    ...
    REG_METHOD("System.String", "Split",
               ani_type_template(arena, "System.Array",
                                 (const ANIType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.String", "ToCharArray",
               ani_type_template(arena, "System.Array",
                                 (const ANIType *[]){ani_type_named(arena, "System.Char"), NULL},
                                 1));
    ...
    REG_STATIC("System.Convert", "ToSingle", ani_type_named(arena, "System.Single"));
    REG_STATIC("System.Convert", "ChangeType", OBJ());

    /* ── System.Guid ───────────────────────────────────────────── */
    REG_TYPE("System.Guid", "Guid", false, valuetype_parent);
    REG_STATIC("System.Guid", "NewGuid", ani_type_named(arena, "System.Guid"));
    REG_STATIC("System.Guid", "Parse", ani_type_named(arena, "System.Guid"));
    ...
    REG_STATIC("System.DateTime", "Now", ani_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "UtcNow", ani_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Today", ani_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Parse", ani_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "TryParse", BOOL_T());
    REG_METHOD("System.DateTime", "AddDays", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddHours", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMinutes", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddSeconds", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMilliseconds", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "Subtract", ani_type_named(arena, "System.TimeSpan"));
    REG_METHOD("System.DateTime", "ToString", STR());
    REG_METHOD("System.DateTime", "ToUniversalTime", ani_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "ToLocalTime", ani_type_named(arena, "System.DateTime"));
    ...
    REG_STATIC("System.DateTimeOffset", "Now", ani_type_named(arena, "System.DateTimeOffset"));
    REG_STATIC("System.DateTimeOffset", "UtcNow", ani_type_named(arena, "System.DateTimeOffset"));
    ...
    REG_STATIC("System.IO.File", "ReadAllBytes",
               ani_type_template(arena, "System.Array",
                                 (const ANIType *[]){ani_type_named(arena, "System.Byte"), NULL},
                                 1));
    ...
    REG_STATIC("System.IO.File", "Open", ani_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenRead", ani_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenWrite", ani_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "Create", ani_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "ReadAllTextAsync",
               ani_type_template(arena, "System.Threading.Tasks.Task",
                                 (const ANIType *[]){STR(), NULL}, 1));
    REG_STATIC("System.IO.File", "WriteAllTextAsync",
               ani_type_named(arena, "System.Threading.Tasks.Task"));
    ...
    REG_STATIC("System.IO.Directory", "CreateDirectory",
               ani_type_named(arena, "System.IO.DirectoryInfo"));
    ...
    REG_STATIC("System.IO.Directory", "EnumerateFiles",
               ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                 (const ANIType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.Text.StringBuilder", "Append",
               ani_type_named(arena, "System.Text.StringBuilder"));
    ...
    REG_STATIC("System.Text.Encoding", "UTF8", ani_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "ASCII", ani_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "Unicode", ani_type_named(arena, "System.Text.Encoding"));
    ...
    REG_STATIC("System.Text.RegularExpressions.Regex", "Match",
               ani_type_named(arena, "System.Text.RegularExpressions.Match"));
    REG_STATIC("System.Text.RegularExpressions.Regex", "Matches",
               ani_type_named(arena, "System.Text.RegularExpressions.MatchCollection"));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerable", "GetEnumerator",
               ani_type_template(arena, "System.Collections.Generic.IEnumerator",
                                 (const ANIType *[]){ani_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.List", "Find", ani_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.List", "FindAll",
               ani_type_template(arena, "System.Collections.Generic.List",
                                 (const ANIType *[]){ani_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IDictionary", "Keys",
               ani_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const ANIType *[]){ani_type_type_param(arena, "TKey"), NULL},
                                 1));
    REG_METHOD("System.Collections.Generic.IDictionary", "Values",
               ani_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const ANIType *[]){ani_type_type_param(arena, "TValue"), NULL},
                                 1));
    ...
    REG_METHOD("System.Collections.Generic.Queue", "Dequeue", ani_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Queue", "Peek", ani_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.Stack", "Pop", ani_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Stack", "Peek", ani_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Key",
               ani_type_type_param(arena, "TKey"));
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Value",
               ani_type_type_param(arena, "TValue"));
    ...
    REG_METHOD("System.Span", "Slice",
               ani_type_template(arena, "System.Span",
                                 (const ANIType *[]){ani_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.ReadOnlySpan", "Slice",
               ani_type_template(arena, "System.ReadOnlySpan",
                                 (const ANIType *[]){ani_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Nullable", "Value", ani_type_type_param(arena, "T"));
    REG_METHOD("System.Nullable", "GetValueOrDefault", ani_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Threading.Tasks.Task", "Exception",
               ani_type_named(arena, "System.AggregateException"));
    ...
    REG_METHOD("System.Threading.CancellationTokenSource", "Token",
               ani_type_named(arena, "System.Threading.CancellationToken"));
    ...
    REG_METHOD("System.Exception", "InnerException",
               ani_type_named(arena, "System.Exception"));
    ...
    REG_EXTENSION("System.Linq.Enumerable.Where", "Where",
                   ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1),
                   ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.OrderBy", "OrderBy",
                   ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1),
                   ani_type_template(arena, "System.Linq.IOrderedEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.ToDictionary", "ToDictionary",
                   ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1),
                   ani_type_template(arena, "System.Collections.Generic.Dictionary",
                                     (const ANIType *[]){UNK(), UNK(), NULL}, 2));
    REG_EXTENSION("System.Linq.Enumerable.ToHashSet", "ToHashSet",
                   ani_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1),
                   ani_type_template(arena, "System.Collections.Generic.HashSet",
                                     (const ANIType *[]){ani_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_STATIC("System.Text.Json.JsonDocument", "Parse",
               ani_type_named(arena, "System.Text.Json.JsonDocument"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "EnsureSuccessStatusCode",
               ani_type_named(arena, "System.Net.Http.HttpResponseMessage"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "Content",
               ani_type_named(arena, "System.Net.Http.HttpContent"));
    ...
    REG_METHOD("Microsoft.Extensions.Logging.ILogger", "BeginScope",
               ani_type_named(arena, "System.IDisposable"));
    ...
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Ok",
               ani_type_named(arena, "Microsoft.AspNetCore.Mvc.OkObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "NotFound",
               ani_type_named(arena, "Microsoft.AspNetCore.Mvc.NotFoundObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "BadRequest",
               ani_type_named(arena, "Microsoft.AspNetCore.Mvc.BadRequestObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "StatusCode",
               ani_type_named(arena, "Microsoft.AspNetCore.Mvc.IActionResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Json",
               ani_type_named(arena, "Microsoft.AspNetCore.Mvc.JsonResult"));
    ...
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "Find", ani_type_type_param(arena, "T"));
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "FindAsync",
               ani_type_template(arena, "System.Threading.Tasks.ValueTask",
                                 (const ANIType *[]){ani_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Lazy", "Value", ani_type_type_param(arena, "T"));
    ...
    REG_GENERIC_TYPE_P1("System.Func", "Func", false,
                         "System.Delegate", single_t_params);
    REG_METHOD("System.Func", "Invoke", ani_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Tuple", "Item1", ani_type_type_param(arena, "T"));
    ...
    REG_STATIC("System.Diagnostics.Stopwatch", "StartNew",
               ani_type_named(arena, "System.Diagnostics.Stopwatch"));
    ...
    REG_METHOD("System.Diagnostics.Stopwatch", "Elapsed",
               ani_type_named(arena, "System.TimeSpan"));
