 ...
 * `signature` (type annotations) is suppressed in ani_resolve_func_name so it never doubles. */
 ...
 * def-vs-call distinction happens in ani_resolve_func_name (returns NULL for a
 ...
 * the ANI_LANG_FSHARP branch in ani_resolve_func_name. */
...
static const ANIEmbeddedLangSpec cfml_embedded_imports[] = {
    ...
    {"cf_script_tag", "cf_script_content", ANI_LANG_CFSCRIPT},
    {NULL, NULL, 0},
};
static const ANIEmbeddedLangSpec vue_embedded_imports[] = {
    {"script_element", "raw_text", ANI_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const ANIEmbeddedLangSpec svelte_embedded_imports[] = {
    {"script_element", "raw_text", ANI_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const ANIEmbeddedLangSpec html_embedded_imports[] = {
    {"script_element", "raw_text", ANI_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const ANIEmbeddedLangSpec astro_embedded_imports[] = {
    ...
    {"frontmatter", "frontmatter_js_block", ANI_LANG_JAVASCRIPT},
    {"script_element", "raw_text", ANI_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
 ...
 * gate is in ani_resolve_func_name (returns NULL for a non-def list). */
 ...
 * ani_resolve_func_name climbs to the parent for naming. A function application
...
static const ANILangSpec lang_specs[ANI_LANG_COUNT] = {
    // ANI_LANG_GO
    [ANI_LANG_GO] = {ANI_LANG_GO, go_func_types, go_class_types, go_field_types, go_module_types,
    ...
    // ANI_LANG_PYTHON
    [ANI_LANG_PYTHON] = {ANI_LANG_PYTHON, py_func_types, py_class_types, empty_types,
    ...
    // ANI_LANG_JAVASCRIPT
    [ANI_LANG_JAVASCRIPT] =
        {ANI_LANG_JAVASCRIPT, js_func_types, js_class_types, empty_types, js_module_types,
    ...
    // ANI_LANG_TYPESCRIPT
    [ANI_LANG_TYPESCRIPT] = {ANI_LANG_TYPESCRIPT, ts_func_types, ts_class_types, empty_types,
    ...
    // ANI_LANG_TSX
    [ANI_LANG_TSX] =
        {ANI_LANG_TSX, ts_func_types, ts_class_types, empty_types, js_module_types, js_call_types,
    ...
    // ANI_LANG_RUST
    [ANI_LANG_RUST] = {ANI_LANG_RUST, rust_func_types, rust_class_types, rust_field_types,
    ...
    // ANI_LANG_JAVA
    [ANI_LANG_JAVA] = {ANI_LANG_JAVA, java_func_types, java_class_types, java_field_types,
    ...
    // ANI_LANG_CPP
    [ANI_LANG_CPP] = {ANI_LANG_CPP, cpp_func_types, cpp_class_types, cpp_field_types,
    ...
    // ANI_LANG_CSHARP
    [ANI_LANG_CSHARP] = {ANI_LANG_CSHARP, cs_func_types, cs_class_types, cs_field_types,
    ...
    // ANI_LANG_PHP
    [ANI_LANG_PHP] = {ANI_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types,
    ...
    // ANI_LANG_LUA
    [ANI_LANG_LUA] = {ANI_LANG_LUA, lua_func_types, empty_types, empty_types, lua_module_types,
    ...
    // ANI_LANG_SCALA
    [ANI_LANG_SCALA] = {ANI_LANG_SCALA, scala_func_types, scala_class_types, empty_types,
    ...
    // ANI_LANG_KOTLIN
    [ANI_LANG_KOTLIN] = {ANI_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types,
    ...
    // ANI_LANG_RUBY
    [ANI_LANG_RUBY] = {ANI_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types,
    ...
    // ANI_LANG_C
    [ANI_LANG_C] = {ANI_LANG_C, c_func_types, c_class_types, c_field_types, c_module_types,
    ...
    // ANI_LANG_BASH
    [ANI_LANG_BASH] = {ANI_LANG_BASH, bash_func_types, empty_types, empty_types, bash_module_types,
    ...
    // ANI_LANG_ZIG
    [ANI_LANG_ZIG] = {ANI_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types,
    ...
    // ANI_LANG_ELIXIR
    [ANI_LANG_ELIXIR] = {ANI_LANG_ELIXIR, elixir_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_HASKELL
    [ANI_LANG_HASKELL] = {ANI_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types,
    ...
    // ANI_LANG_OCAML
    [ANI_LANG_OCAML] = {ANI_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types,
    ...
    // ANI_LANG_OBJC
    [ANI_LANG_OBJC] = {ANI_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types,
    ...
    // ANI_LANG_SWIFT
    [ANI_LANG_SWIFT] = {ANI_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types,
    ...
    // ANI_LANG_DART
    [ANI_LANG_DART] = {ANI_LANG_DART, dart_func_types, dart_class_types, dart_field_types,
    ...
    // ANI_LANG_PERL
    [ANI_LANG_PERL] = {ANI_LANG_PERL, perl_func_types, empty_types, empty_types, perl_module_types,
    ...
    // ANI_LANG_GROOVY
    [ANI_LANG_GROOVY] = {ANI_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types,
    ...
    // ANI_LANG_ERLANG
    [ANI_LANG_ERLANG] = {ANI_LANG_ERLANG, erlang_func_types, erlang_class_types, empty_types,
    ...
    // ANI_LANG_R
    [ANI_LANG_R] = {ANI_LANG_R, r_func_types, empty_types, empty_types, r_module_types,
    ...
    // ANI_LANG_HTML
    [ANI_LANG_HTML] = {ANI_LANG_HTML, empty_types, empty_types, empty_types, html_module_types,
    ...
    // ANI_LANG_CSS
    [ANI_LANG_CSS] = {ANI_LANG_CSS, empty_types, empty_types, empty_types, css_module_types,
    ...
    // ANI_LANG_SCSS
    [ANI_LANG_SCSS] = {ANI_LANG_SCSS, scss_func_types, empty_types, empty_types, scss_module_types,
    ...
    // ANI_LANG_YAML
    [ANI_LANG_YAML] = {ANI_LANG_YAML, empty_types, empty_types, empty_types, yaml_module_types,
    ...
    // ANI_LANG_TOML
    [ANI_LANG_TOML] = {ANI_LANG_TOML, empty_types, toml_class_types, empty_types, toml_module_types,
    ...
    // ANI_LANG_HCL
    [ANI_LANG_HCL] = {ANI_LANG_HCL, empty_types, hcl_class_types, empty_types, hcl_module_types,
    ...
    // ANI_LANG_SQL
    [ANI_LANG_SQL] = {ANI_LANG_SQL, sql_func_types, sql_class_types, sql_field_types,
    ...
    // ANI_LANG_DOCKERFILE
    [ANI_LANG_DOCKERFILE] = {ANI_LANG_DOCKERFILE, empty_types, empty_types, empty_types,
    ...
    // ANI_LANG_CLOJURE
    [ANI_LANG_CLOJURE] = {ANI_LANG_CLOJURE, clojure_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_FSHARP
    [ANI_LANG_FSHARP] = {ANI_LANG_FSHARP, fsharp_func_types, fsharp_class_types, empty_types,
    ...
    // ANI_LANG_JULIA
    [ANI_LANG_JULIA] = {ANI_LANG_JULIA, julia_func_types, julia_class_types, empty_types,
    ...
    // ANI_LANG_VIMSCRIPT
    [ANI_LANG_VIMSCRIPT] = {ANI_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_NIX
    [ANI_LANG_NIX] = {ANI_LANG_NIX, nix_func_types, empty_types, empty_types, nix_module_types,
    ...
    // ANI_LANG_COMMONLISP
    [ANI_LANG_COMMONLISP] = {ANI_LANG_COMMONLISP, commonlisp_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_ELM
    [ANI_LANG_ELM] = {ANI_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types,
    ...
    // ANI_LANG_FORTRAN
    [ANI_LANG_FORTRAN] = {ANI_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types,
    ...
    // ANI_LANG_CUDA (reuses C++ node types)
    [ANI_LANG_CUDA] = {ANI_LANG_CUDA, cpp_func_types, cpp_class_types, cpp_field_types,
                       cpp_module_types, cpp_call_types, cpp_import_types, cpp_import_types,
                       cpp_branch_types, cpp_var_types, cpp_assign_types, cpp_throw_types, NULL,
                       empty_types, cpp_env_funcs, NULL, tree_sitter_cuda, NULL},

    // ANI_LANG_COBOL
    [ANI_LANG_COBOL] = {ANI_LANG_COBOL, cobol_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_VERILOG
    [ANI_LANG_VERILOG] = {ANI_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types,
    ...
    // ANI_LANG_EMACSLISP
    [ANI_LANG_EMACSLISP] = {ANI_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types,
                            elisp_module_types, elisp_call_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_elisp, NULL},

    // ANI_LANG_JSON
    [ANI_LANG_JSON] = {ANI_LANG_JSON, empty_types, empty_types, empty_types, json_module_types,
    ...
    // ANI_LANG_XML
    [ANI_LANG_XML] = {ANI_LANG_XML, empty_types, xml_class_types, empty_types, xml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_xml, NULL},

    // ANI_LANG_MARKDOWN
    [ANI_LANG_MARKDOWN] = {ANI_LANG_MARKDOWN, empty_types, markdown_class_types, empty_types,
                           markdown_module_types, empty_types, empty_types, empty_types,
                           empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                           NULL, NULL, tree_sitter_markdown, NULL},

    // ANI_LANG_MAKEFILE
    [ANI_LANG_MAKEFILE] = {ANI_LANG_MAKEFILE, makefile_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_CMAKE
    [ANI_LANG_CMAKE] = {ANI_LANG_CMAKE, cmake_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_PROTOBUF
    [ANI_LANG_PROTOBUF] = {ANI_LANG_PROTOBUF, protobuf_func_types, protobuf_class_types,
    ...
    // ANI_LANG_GRAPHQL
    [ANI_LANG_GRAPHQL] = {ANI_LANG_GRAPHQL, empty_types, graphql_class_types, graphql_field_types,
                          graphql_module_types, empty_types, empty_types, empty_types, empty_types,
                          empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                          tree_sitter_graphql, NULL},

    // ANI_LANG_VUE
    [ANI_LANG_VUE] = {ANI_LANG_VUE, empty_types, empty_types, empty_types, vue_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_vue,
                      vue_embedded_imports},

    // ANI_LANG_SVELTE
    [ANI_LANG_SVELTE] = {ANI_LANG_SVELTE, empty_types, empty_types, empty_types,
    ...
    // ANI_LANG_MESON
    [ANI_LANG_MESON] = {ANI_LANG_MESON, meson_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_GLSL (reuses C node types)
    [ANI_LANG_GLSL] = {ANI_LANG_GLSL, c_func_types, c_class_types, c_field_types, c_module_types,
                       c_call_types, c_import_types, empty_types, c_branch_types, c_var_types,
                       c_assign_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_glsl,
                       NULL},

    // ANI_LANG_INI
    [ANI_LANG_INI] = {ANI_LANG_INI, empty_types, ini_class_types, empty_types, ini_module_types,
    ...
    // ANI_LANG_MATLAB
    [ANI_LANG_MATLAB] = {ANI_LANG_MATLAB, matlab_func_types, matlab_class_types, empty_types,
    ...
    // ANI_LANG_LEAN
    [ANI_LANG_LEAN] = {ANI_LANG_LEAN, lean_func_types, lean_class_types, empty_types,
    ...
    // ANI_LANG_FORM
    [ANI_LANG_FORM] = {ANI_LANG_FORM, form_func_types, empty_types, empty_types, form_module_types,
    ...
    // ANI_LANG_MAGMA
    [ANI_LANG_MAGMA] = {ANI_LANG_MAGMA, magma_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_WOLFRAM
    [ANI_LANG_WOLFRAM] = {ANI_LANG_WOLFRAM, wolfram_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_SOLIDITY
    [ANI_LANG_SOLIDITY] = {ANI_LANG_SOLIDITY, solidity_func_types, solidity_class_types,
    ...
    // ANI_LANG_TYPST
    [ANI_LANG_TYPST] = {ANI_LANG_TYPST, typst_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_GDSCRIPT
    [ANI_LANG_GDSCRIPT] = {ANI_LANG_GDSCRIPT, gdscript_func_types, gdscript_class_types,
    ...
    // ANI_LANG_QML
    [ANI_LANG_QML] =
        {ANI_LANG_QML, ts_func_types, qml_class_types, qml_field_types, js_module_types,
    ...
    // ANI_LANG_CFSCRIPT
    [ANI_LANG_CFSCRIPT] =
        {ANI_LANG_CFSCRIPT, cfscript_func_types, empty_types, cfscript_field_types, js_module_types,
    ...
    // ANI_LANG_CFML
    [ANI_LANG_CFML] = {ANI_LANG_CFML, cfml_func_types, empty_types, empty_types, cfml_module_types,
    ...
    // ANI_LANG_GLEAM
    [ANI_LANG_GLEAM] = {ANI_LANG_GLEAM, gleam_func_types, gleam_class_types, gleam_field_types,
    ...
    // ANI_LANG_POWERSHELL
    [ANI_LANG_POWERSHELL] = {ANI_LANG_POWERSHELL, powershell_func_types, powershell_class_types,
    ...
    // ANI_LANG_PASCAL
    [ANI_LANG_PASCAL] = {ANI_LANG_PASCAL, pascal_func_types, pascal_class_types, pascal_field_types,
    ...
    // ANI_LANG_DLANG
    [ANI_LANG_DLANG] = {ANI_LANG_DLANG, d_func_types, d_class_types, d_field_types, d_module_types,
    ...
    // ANI_LANG_SCHEME
    [ANI_LANG_SCHEME] = {ANI_LANG_SCHEME, scheme_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_CHIALISP — lisp-family shape (generic list/symbol nodes)
    [ANI_LANG_CHIALISP] = {ANI_LANG_CHIALISP, chialisp_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_FENNEL
    [ANI_LANG_FENNEL] = {ANI_LANG_FENNEL, fennel_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_FISH
    [ANI_LANG_FISH] = {ANI_LANG_FISH, fish_func_types, empty_types, empty_types, fish_module_types,
    ...
    // ANI_LANG_AWK
    [ANI_LANG_AWK] = {ANI_LANG_AWK, awk_func_types, empty_types, empty_types, awk_module_types,
    ...
    // ANI_LANG_ZSH
    [ANI_LANG_ZSH] = {ANI_LANG_ZSH, zsh_func_types, empty_types, empty_types, zsh_module_types,
    ...
    // ANI_LANG_TCL
    [ANI_LANG_TCL] = {ANI_LANG_TCL, tcl_func_types, tcl_class_types, empty_types, tcl_module_types,
    ...
    // ANI_LANG_ADA
    [ANI_LANG_ADA] = {ANI_LANG_ADA, ada_func_types, ada_class_types, ada_field_types,
    ...
    // ANI_LANG_AGDA
    [ANI_LANG_AGDA] = {ANI_LANG_AGDA, agda_func_types, agda_class_types, empty_types,
    ...
    // ANI_LANG_RACKET
    [ANI_LANG_RACKET] = {ANI_LANG_RACKET, racket_func_types, racket_class_types, empty_types,
    ...
    // ANI_LANG_ODIN
    [ANI_LANG_ODIN] = {ANI_LANG_ODIN, odin_func_types, odin_class_types, odin_field_types,
    ...
    // ANI_LANG_RESCRIPT
    [ANI_LANG_RESCRIPT] = {ANI_LANG_RESCRIPT, rescript_func_types, rescript_class_types,
    ...
    // ANI_LANG_PURESCRIPT
    [ANI_LANG_PURESCRIPT] = {ANI_LANG_PURESCRIPT, purescript_func_types, purescript_class_types,
    ...
    // ANI_LANG_NICKEL
    [ANI_LANG_NICKEL] = {ANI_LANG_NICKEL, nickel_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_CRYSTAL
    [ANI_LANG_CRYSTAL] = {ANI_LANG_CRYSTAL, crystal_func_types, crystal_class_types,
    ...
    // ANI_LANG_TEAL
    [ANI_LANG_TEAL] = {ANI_LANG_TEAL, teal_func_types, teal_class_types, empty_types,
    ...
    // ANI_LANG_HARE
    [ANI_LANG_HARE] = {ANI_LANG_HARE, hare_func_types, hare_class_types, empty_types,
    ...
    // ANI_LANG_PONY
    [ANI_LANG_PONY] = {ANI_LANG_PONY, pony_func_types, pony_class_types, empty_types,
    ...
    // ANI_LANG_LUAU
    [ANI_LANG_LUAU] = {ANI_LANG_LUAU, luau_func_types, luau_class_types, empty_types,
    ...
    // ANI_LANG_JANET
    [ANI_LANG_JANET] = {ANI_LANG_JANET, empty_types, empty_types, empty_types, janet_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL,
                        tree_sitter_janet_simple, NULL},

    // ANI_LANG_SWAY
    [ANI_LANG_SWAY] = {ANI_LANG_SWAY, sway_func_types, sway_class_types, empty_types,
    ...
    // ANI_LANG_NASM
    [ANI_LANG_NASM] = {ANI_LANG_NASM, nasm_func_types, nasm_class_types, empty_types,
    ...
    // ANI_LANG_ASSEMBLY
    [ANI_LANG_ASSEMBLY] = {ANI_LANG_ASSEMBLY, assembly_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_ASTRO
    [ANI_LANG_ASTRO] = {ANI_LANG_ASTRO, empty_types, empty_types, empty_types, astro_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_astro,
                        astro_embedded_imports},

    // ANI_LANG_BLADE
    [ANI_LANG_BLADE] = {ANI_LANG_BLADE, empty_types, empty_types, empty_types, blade_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_blade,
                        NULL},

    // ANI_LANG_JUST
    [ANI_LANG_JUST] = {ANI_LANG_JUST, just_func_types, empty_types, empty_types, just_module_types,
    ...
    // ANI_LANG_WGSL
    [ANI_LANG_WGSL] = {ANI_LANG_WGSL, wgsl_func_types, wgsl_class_types, empty_types,
    ...
    // ANI_LANG_KDL
    [ANI_LANG_KDL] = {ANI_LANG_KDL, empty_types, empty_types, empty_types, kdl_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_kdl, NULL},

    // ANI_LANG_JSON5
    [ANI_LANG_JSON5] = {ANI_LANG_JSON5, empty_types, empty_types, empty_types, json5_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_json5,
                        NULL},

    // ANI_LANG_JSONNET
    [ANI_LANG_JSONNET] = {ANI_LANG_JSONNET, jsonnet_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_RON
    [ANI_LANG_RON] = {ANI_LANG_RON, empty_types, empty_types, empty_types, ron_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_ron, NULL},

    // ANI_LANG_THRIFT
    [ANI_LANG_THRIFT] = {ANI_LANG_THRIFT, thrift_func_types, thrift_class_types, thrift_field_types,
    ...
    // ANI_LANG_CAPNP
    [ANI_LANG_CAPNP] = {ANI_LANG_CAPNP, capnp_func_types, capnp_class_types, capnp_field_types,
    ...
    // ANI_LANG_PROPERTIES
    [ANI_LANG_PROPERTIES] = {ANI_LANG_PROPERTIES, empty_types, empty_types, empty_types,
    ...
    // ANI_LANG_SSHCONFIG
    [ANI_LANG_SSHCONFIG] = {ANI_LANG_SSHCONFIG, empty_types, empty_types, empty_types,
                            sshconfig_module_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_ssh_config, NULL},

    // ANI_LANG_BIBTEX
    [ANI_LANG_BIBTEX] = {ANI_LANG_BIBTEX, empty_types, empty_types, empty_types,
                         bibtex_module_types, bibtex_call_types, empty_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_bibtex, NULL},

    // ANI_LANG_STARLARK
    [ANI_LANG_STARLARK] = {ANI_LANG_STARLARK, starlark_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_BICEP
    [ANI_LANG_BICEP] = {ANI_LANG_BICEP, bicep_func_types, bicep_class_types, empty_types,
    ...
    // ANI_LANG_CSV
    [ANI_LANG_CSV] = {ANI_LANG_CSV, empty_types, empty_types, empty_types, csv_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_csv, NULL},

    // ANI_LANG_REQUIREMENTS
    [ANI_LANG_REQUIREMENTS] = {ANI_LANG_REQUIREMENTS, empty_types, empty_types, empty_types,
    ...
    // ANI_LANG_HLSL
    [ANI_LANG_HLSL] = {ANI_LANG_HLSL, hlsl_func_types, hlsl_class_types, empty_types,
    ...
    // ANI_LANG_VHDL
    [ANI_LANG_VHDL] = {ANI_LANG_VHDL, vhdl_func_types, vhdl_class_types, empty_types,
    ...
    [ANI_LANG_SYSTEMVERILOG] = {ANI_LANG_SYSTEMVERILOG, systemverilog_func_types,
    ...
    // ANI_LANG_DEVICETREE
    [ANI_LANG_DEVICETREE] = {ANI_LANG_DEVICETREE, empty_types, empty_types, empty_types,
    ...
    [ANI_LANG_LINKERSCRIPT] = {ANI_LANG_LINKERSCRIPT, empty_types, empty_types, empty_types,
                               linkerscript_module_types, linkerscript_call_types, empty_types,
                               empty_types, empty_types, empty_types, empty_types, empty_types,
                               NULL, empty_types, NULL, NULL, tree_sitter_linkerscript, NULL},

    // ANI_LANG_GN
    [ANI_LANG_GN] = {ANI_LANG_GN, empty_types, empty_types, empty_types, gn_module_types,
    ...
    // ANI_LANG_KCONFIG
    [ANI_LANG_KCONFIG] = {ANI_LANG_KCONFIG, empty_types, kconfig_class_types, empty_types,
    ...
    // ANI_LANG_BITBAKE
    [ANI_LANG_BITBAKE] = {ANI_LANG_BITBAKE, bitbake_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_SMALI
    [ANI_LANG_SMALI] = {ANI_LANG_SMALI, smali_func_types, smali_class_types, smali_field_types,
                        smali_module_types, empty_types, smali_import_types, empty_types,
                        empty_types, empty_types, empty_types, empty_types, NULL, empty_types, NULL,
                        NULL, tree_sitter_smali, NULL},

    // ANI_LANG_TABLEGEN
    [ANI_LANG_TABLEGEN] = {ANI_LANG_TABLEGEN, tablegen_func_types, tablegen_class_types,
                           empty_types, tablegen_module_types, empty_types, tablegen_import_types,
                           empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                           empty_types, NULL, NULL, tree_sitter_tablegen, NULL},

    // ANI_LANG_ISPC
    [ANI_LANG_ISPC] = {ANI_LANG_ISPC, ispc_func_types, ispc_class_types, empty_types,
    ...
    // ANI_LANG_CAIRO
    [ANI_LANG_CAIRO] = {ANI_LANG_CAIRO, cairo_func_types, cairo_class_types, empty_types,
    ...
    // ANI_LANG_MOVE
    [ANI_LANG_MOVE] = {ANI_LANG_MOVE, move_func_types, empty_types, empty_types, move_module_types,
    ...
    // ANI_LANG_SQUIRREL
    [ANI_LANG_SQUIRREL] = {ANI_LANG_SQUIRREL, squirrel_func_types, squirrel_class_types,
    ...
    // ANI_LANG_FUNC
    [ANI_LANG_FUNC] = {ANI_LANG_FUNC, func_func_types, empty_types, empty_types, func_module_types,
    ...
    // ANI_LANG_REGEX
    [ANI_LANG_REGEX] = {ANI_LANG_REGEX, empty_types, empty_types, empty_types, regex_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_regex,
                        NULL},

    // ANI_LANG_JSDOC
    [ANI_LANG_JSDOC] = {ANI_LANG_JSDOC, empty_types, empty_types, empty_types, jsdoc_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_jsdoc,
                        NULL},

    // ANI_LANG_RST
    [ANI_LANG_RST] = {ANI_LANG_RST, empty_types, empty_types, empty_types, rst_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_rst, NULL},

    // ANI_LANG_BEANCOUNT
    [ANI_LANG_BEANCOUNT] = {ANI_LANG_BEANCOUNT, empty_types, empty_types, empty_types,
                            beancount_module_types, empty_types, beancount_import_types,
                            empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                            empty_types, NULL, NULL, tree_sitter_beancount, NULL},

    // ANI_LANG_MERMAID
    [ANI_LANG_MERMAID] = {ANI_LANG_MERMAID, empty_types, empty_types, empty_types,
                          mermaid_module_types, empty_types, empty_types, empty_types, empty_types,
                          empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                          tree_sitter_mermaid, NULL},

    // ANI_LANG_PUPPET
    [ANI_LANG_PUPPET] = {ANI_LANG_PUPPET, puppet_func_types, puppet_class_types, empty_types,
    ...
    // ANI_LANG_SMITHY
    [ANI_LANG_SMITHY] = {ANI_LANG_SMITHY, smithy_func_types, smithy_class_types, smithy_field_types,
                         smithy_module_types, empty_types, smithy_import_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_smithy, NULL},

    // ANI_LANG_WIT
    [ANI_LANG_WIT] = {ANI_LANG_WIT, wit_func_types, wit_class_types, wit_field_types,
                      wit_module_types, empty_types, wit_import_types, empty_types, empty_types,
                      empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                      tree_sitter_wit, NULL},

    // ANI_LANG_TLAPLUS
    [ANI_LANG_TLAPLUS] = {ANI_LANG_TLAPLUS, tlaplus_func_types, empty_types, empty_types,
    ...
    // ANI_LANG_PKL
    [ANI_LANG_PKL] = {ANI_LANG_PKL, pkl_func_types, pkl_class_types, empty_types, pkl_module_types,
    ...
    // ANI_LANG_GOMOD
    [ANI_LANG_GOMOD] = {ANI_LANG_GOMOD, empty_types, empty_types, empty_types, gomod_module_types,
    ...
    // ANI_LANG_APEX
    [ANI_LANG_APEX] = {ANI_LANG_APEX, apex_func_types, apex_class_types, apex_field_types,
    ...
    // ANI_LANG_SOQL
    [ANI_LANG_SOQL] = {ANI_LANG_SOQL, empty_types, empty_types, empty_types, soql_module_types,
    ...
    // ANI_LANG_SOSL
    [ANI_LANG_SOSL] = {ANI_LANG_SOSL, empty_types, empty_types, empty_types, sosl_module_types,
    ...
    // ANI_LANG_KUSTOMIZE — reuses YAML grammar; semantic extraction via ani_extract_k8s()
    [ANI_LANG_KUSTOMIZE] = {ANI_LANG_KUSTOMIZE, yaml_var_types, empty_types, empty_types,
                            yaml_module_types, empty_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                            tree_sitter_yaml, NULL},

    // ANI_LANG_K8S — reuses YAML grammar; semantic extraction via ani_extract_k8s()
    [ANI_LANG_K8S] = {ANI_LANG_K8S, yaml_var_types, empty_types, empty_types, yaml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_yaml, NULL},

    // ANI_LANG_PINE — Pine Script (TradingView). kvarenzn/tree-sitter-pine (ISC).
    [ANI_LANG_PINE] = {ANI_LANG_PINE, pine_func_types, pine_class_types, empty_types,
    ...
    // ANI_LANG_MOJO
    [ANI_LANG_MOJO] = {ANI_LANG_MOJO, mojo_func_types, mojo_class_types, empty_types,
    ...
    // ANI_LANG_OBJECTSCRIPT_UDL — InterSystems ObjectScript class (.cls) UDL.
    // intersystems/tree-sitter-objectscript.
    [ANI_LANG_OBJECTSCRIPT_UDL] = {ANI_LANG_OBJECTSCRIPT_UDL, objectscript_udl_func_types,
    ...
    [ANI_LANG_OBJECTSCRIPT_ROUTINE] = {ANI_LANG_OBJECTSCRIPT_ROUTINE,
    ...
    // ANI_LANG_OBJECTSCRIPT_EXPORT — Studio Export XML. No grammar row: the
    // pipeline transcodes Export XML to UDL (iris_export_xml.c) and re-extracts
    // each class as ANI_LANG_OBJECTSCRIPT_UDL, so this language never reaches
    // ani_lang_spec()/ani_ts_language() directly. Left as a zero spec.

    // ANI_LANG_ARKTS
    [ANI_LANG_ARKTS] = {ANI_LANG_ARKTS, ts_func_types, arkts_class_types, arkts_field_types,
                        js_module_types, js_call_types, js_import_types, js_import_types,
                        js_branch_types, js_var_types,
    ...
    // ANI_LANG_PLSQL — Oracle PL/SQL. AndreasMaierDe/tree-sitter-plsql (MIT).
    [ANI_LANG_PLSQL] = {ANI_LANG_PLSQL, plsql_func_types, plsql_class_types, empty_types,
...
_Static_assert(sizeof(lang_specs) / sizeof(lang_specs[0]) == ANI_LANG_COUNT,
               "lang_specs array size must match ANI_LANG_COUNT");

const ANILangSpec *ani_lang_spec(ANILanguage lang) {
    if (lang < 0 || lang >= ANI_LANG_COUNT) {
        return NULL;
    }
    const ANILangSpec *spec = &lang_specs[lang];
...
const TSLanguage *ani_ts_language(ANILanguage lang) {
    const ANILangSpec *spec = ani_lang_spec(lang);
