#ifndef ANI_SQLITE_WRITER_H
#define ANI_SQLITE_WRITER_H
...
// indexes, sqlite_master) is written at finalize. ani_write_db() above is a
// one-shot wrapper over this API (open -> append all nodes -> finalize) and
// produces byte-identical output.
//
// Usage: w = ani_writer_open(path);
//        ani_writer_append_nodes(w, batch, n) x N  (ascending, contiguous ids);
//        ani_writer_finalize(w, ...);   // consumes + frees w, closes the file.
typedef struct ani_db_writer ani_db_writer_t;
