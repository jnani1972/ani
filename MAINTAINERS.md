...
| Language extraction and LSP resolution | `internal/ani/`, `tools/`, `tests/test_*_lsp.c`, `tests/test_extraction.c`, `tests/test_grammar_*.c` | TBD | `@DeusData` |
...
| CI and release operations | `.github/workflows/`, `scripts/ci/`, `Makefile.ani` | `@DeusData` only initially | `@DeusData` |
