...
#ifndef ANI_FOUNDATION_MACOS_ACL_H
#define ANI_FOUNDATION_MACOS_ACL_H
...
bool ani_macos_extended_acl_fd_is_empty(int fd);
...
bool ani_macos_extended_acl_fd_is_deny_only(int fd);
...
bool ani_macos_extended_acl_fd_clear(int fd);
