 ...
 */
#ifndef ANI_COMPAT_FS_H
#define ANI_COMPAT_FS_H
...
#define ANI_DIRENT_NAME_MAX 1024

typedef struct ani_dir ani_dir_t;

typedef struct {
    char name[ANI_DIRENT_NAME_MAX];
    bool is_dir;
 ...
 * valid until the next ani_readdir call on the same handle. */
