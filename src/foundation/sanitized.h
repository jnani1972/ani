 ...
 *
 *   ANI_SANITIZED_BUILD — set by the build system (Makefile.ani), and the ONLY
 ...
 * `make CFLAGS_EXTRA=-fsanitize=address` that never went near Makefile.ani.
 */
#ifndef ANI_SANITIZED_H
#define ANI_SANITIZED_H
...
#if defined(ANI_SANITIZED_BUILD) && ANI_SANITIZED_BUILD
#define ANI_SANITIZED 1
...
#define ANI_SANITIZED 1
#else
#define ANI_SANITIZED 0
#endif

#endif /* ANI_SANITIZED_H */
