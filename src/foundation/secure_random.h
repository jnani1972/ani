#ifndef ANI_SECURE_RANDOM_H
#define ANI_SECURE_RANDOM_H
...
bool ani_secure_random(void *buffer, size_t length);
...
void ani_secure_zero(void *buffer, size_t length);

#endif /* ANI_SECURE_RANDOM_H */
