 ...
 *
 * Off unless ANI_MEM_PROFILE=1. All tables are fixed-capacity and allocated
 ...
 */
#ifndef ANI_MEM_PROFILE_H
#define ANI_MEM_PROFILE_H

#include <stdbool.h>
#include <stddef.h>

/* Gate: ANI_MEM_PROFILE=1. Read once, cached. */
bool ani_mem_profile_enabled(void);

/* Minimum allocation size recorded, from ANI_MEM_PROFILE_MIN (bytes). */
