 ...
 */
#ifndef ANI_CONFIG_YAML_EDIT_H
#define ANI_CONFIG_YAML_EDIT_H
 ...
 * "<file_path>.ani-yaml.lock" regular file, created with mode 0600 and held by
 ...
 * ani_yaml_encode_double_quoted_scalar(). Full-line comments remain allowed.
 *
 ...
 * return ANI_YAML_IDENTITY_EDIT_FOREIGN. Errors return
 ...
 * ani_yaml_encode_double_quoted_scalar().
 *
 ...
 * ANI_YAML_IDENTITY_EDIT_FOREIGN. Removal deletes only the exact canonical
 ...
 * concurrency failures return ANI_YAML_IDENTITY_EDIT_ERROR byte-identically. */
enum {
    ANI_YAML_IDENTITY_EDIT_ERROR = -1,
    ANI_YAML_IDENTITY_EDIT_OK = 0,
    ANI_YAML_IDENTITY_EDIT_FOREIGN = 1
};
...
typedef void (*ani_yaml_precommit_test_hook_t)(const char *file_path, void *context);
