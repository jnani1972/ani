 ...
 */
#ifndef ANI_DAEMON_APPLICATION_INTERNAL_H
#define ANI_DAEMON_APPLICATION_INTERNAL_H

#include "daemon/application.h"
#include "mcp/mcp.h" /* ani_jsonrpc_request_t */
...
bool ani_daemon_application_session_retains_store_for_test(
    const ani_daemon_runtime_application_session_t *session);
...
#endif /* ANI_DAEMON_APPLICATION_INTERNAL_H */
