 ...
 */
#ifndef ANI_DAEMON_HOST_INTERNAL_H
#define ANI_DAEMON_HOST_INTERNAL_H
...
typedef bool (*ani_daemon_host_cleanup_release_for_test_fn)(void *context);
...
bool ani_daemon_host_state_prepare_for_test(const struct ani_daemon_ipc_endpoint *endpoint);
...
} ani_daemon_host_http_reconcile_test_result_t;
...
} ani_daemon_host_http_free_refusal_test_result_t;
...
#endif /* ANI_DAEMON_HOST_INTERNAL_H */
