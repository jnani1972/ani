 ...
 */
#ifndef ANI_AST_PROFILE_H
#define ANI_AST_PROFILE_H
 ...
 * buf must be at least ANI_AST_PROFILE_BUF bytes. */
enum { ANI_AST_PROFILE_BUF = 200 };
 ...
 * out must have ANI_AST_PROFILE_DIMS elements. */
void ani_ast_profile_to_vector(const ani_ast_profile_t *p, float *out);

#endif /* ANI_AST_PROFILE_H */
