...
FUNC_LIST="system popen ani_popen execl fork"
...
while IFS= read -r file; do
    ...
    for func in $FUNC_LIST; do
        ...
        # 'popen(' must NOT match 'ani_popen(' — use [^a-z] negative class
        case "$func" in
            ani_popen) pattern="ani_popen(" ;;
...
while IFS= read -r file; do
    ...
    DANGER_LINES=$(grep -n 'system(\|popen(\|ani_popen(\|connect(\|execl(' "$file" 2>/dev/null \
