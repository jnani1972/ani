...
WORK="$(mktemp -d "${TMPDIR:-/tmp}/ani-vt-public.XXXXXX")"
...
publish_copy "$VT_ASSOCIATIONS" ani-release-scan-associations-v3 virustotal-associations.tsv
publish_copy "$VT_EXPECTED_SCAN_SET" ani-release-scan-set-v2 virustotal-scan-set.tsv
publish_copy "$VT_RESULTS_PATH" ani-virustotal-results-v2 virustotal-results.tsv
