...

{
    ...
    echo
    echo "This file accompanies the ani binary distribution."
    ...
    echo "---"
    echo
    cat "$ROOT/internal/ani/vendored/grammars/MANIFEST.md"

    find "$ROOT/vendored" "$ROOT/internal/ani/vendored" -type f \
