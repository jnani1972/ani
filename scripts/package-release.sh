...
Archive contents — one executable, no sidecars:
  unix:    ani LICENSE install.sh THIRD_PARTY_NOTICES.md (.tar.gz)
  windows: ani.exe LICENSE install.ps1 THIRD_PARTY_NOTICES.md (.zip)
...
if [ "$GOOS" = "windows" ]; then
    STAGED_BINARY_NAME="ani.exe"
    INSTALLER="install.ps1"
    ARCHIVE_OUT="$OUT_DIR/$NAME.zip"
else
    STAGED_BINARY_NAME="ani"
    ...
    cat >"$stage/manifest.json" <<EOF
{
  ...
  "author": { "name": "jnani1972", "url": "https://github.com/jnani1972" },
  "repository": { "type": "git", "url": "https://github.com/jnani1972/ani" },
  "homepage": "https://jnani1972.github.io/ani/",
  "license": "MIT",
  "server": {
    "type": "binary",
    "entry_point": "$entry",
