#!/usr/bin/env bash
# vendor-grammar.sh: Vendor a single tree-sitter grammar into internal/ani/vendored/grammars/<name>/
...
GRAMMAR_DIR="$PROJECT_DIR/internal/ani/vendored/grammars/$NAME"
TMPDIR="$(mktemp -d)"
