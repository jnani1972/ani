...
The `ani-bin` package is available at: https://aur.archlinux.org/packages/ani-bin
...
```bash
# Standard server
nix run github:jnani1972/ani

# Server with the embedded graph UI
nix run github:jnani1972/ani#ani-ui -- --ui=true --port=9749
...
```bash
nix build github:jnani1972/ani                          # standard
nix build github:jnani1972/ani#ani-ui   # with UI
```
...
- **SLSA Level 3** — cryptographic build provenance generated by the trusted GitHub Actions build workflow; verify with `gh attestation verify <file> --repo jnani1972/ani --signer-workflow jnani1972/ani/.github/workflows/_build.yml`
