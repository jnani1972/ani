...
// Install:
//
//	go install github.com/DeusData/ani/pkg/go/cmd/ani@latest
package main
...
func main() {
	...
	if mutation == "update" {
		fmt.Fprintln(
			os.Stderr,
			"This Go wrapper is maintained by Go. Update it with \"go install github.com/DeusData/ani/pkg/go/cmd/ani@latest\".",
		)
		os.Exit(2)
	}
