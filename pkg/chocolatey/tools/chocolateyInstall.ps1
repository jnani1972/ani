...
$packageName = 'ani'
$version     = '0.10.8'
$url64       = "https://github.com/jnani1972/ani/releases/download/v${version}/ani-windows-amd64.zip"
...
$binPath = Join-Path $installDir 'ani.exe'
Install-BinFile -Name 'ani' -Path $binPath
