class Ani < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jnani1972/ani/releases/download/v#{version}/ani-darwin-arm64.tar.gz"
      sha256 "0ebf02328207d4c3d862c837b5e973de5bac808df92b0941737721d467287f7f"
    end
    on_intel do
      url "https://github.com/jnani1972/ani/releases/download/v#{version}/ani-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/jnani1972/ani/releases/download/v#{version}/ani-linux-arm64.tar.gz"
      sha256 "967b9eababfdbd2ef1987c571d55bc7c028cd1db7f99279830634c58db311e32"
    end
    on_intel do
      url "https://github.com/jnani1972/ani/releases/download/v#{version}/ani-linux-amd64.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      To tap this formula directly:
        brew tap jnani1972/ani https://github.com/jnani1972/ani
        brew install ani
    EOS
  end

  test do
    assert_match "ani", shell_output("#{bin}/ani --version")
  end
end
